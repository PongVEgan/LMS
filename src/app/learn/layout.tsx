...
function SidebarContent({ onClose }: { onClose?: () => void }) {
  ...
  const nonCourseSlugs = ["login", "register", "forgot-password", "reset-password", "profile", "community", "checkout", "certificates"];
      ...
      <nav className="flex-1 overflow-y-auto">
        {isInsideCourse && chapters.length > 0 ? (
          ...
          <div className="p-3 space-y-1">
            ...
            <Link href="/learn/certificates" onClick={onClose} className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition"
              style={{ background: pathname.startsWith("/learn/certificates") ? "var(--lms-accent-bg)" : "transparent", color: pathname.startsWith("/learn/certificates") ? "var(--lms-text)" : "var(--lms-text-secondary)", fontWeight: pathname.startsWith("/learn/certificates") ? 500 : 400 }}>
